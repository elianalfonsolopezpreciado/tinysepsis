...
from tinysepsis.demo.app import app, PredictRequest, _build_sequence
...
def test_build_sequence_shapes_and_padding(monkeypatch):
    ...
    seq, pad_mask, static, contributions = _build_sequence(req, seq_len=24)
